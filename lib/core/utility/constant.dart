const String enFontBase = "sofia";
const String enFontSecondry = "shadow";

class AppImage {
  static String cameraIcon = "assets/icons/camera.png";
  static String drawingIcon = "assets/icons/drawing.png";
  static String fileIcon = "assets/icons/file.png";
  static String micIcon = "assets/icons/mic.png";
